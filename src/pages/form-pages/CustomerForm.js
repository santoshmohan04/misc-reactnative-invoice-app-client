        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.card}>
                    <FormField label="Customer Name *" control={control} name="name"
                    ...
                    <FormField label="Email" control={control} name="email"
                    ...
                    <FormField label="Company" control={control} name="company"
                        inputProps={{ placeholder: 'Company', keyboardType: 'default' }} />
                    <FormField label="Phone" control={control} name="phone"
                        inputProps={{ placeholder: 'Phone', keyboardType: 'phone-pad' }} />
                    <FormField label="Mobile" control={control} name="mobile"
                        inputProps={{ placeholder: 'Mobile', keyboardType: 'phone-pad' }} />
                </View>
                <View style={styles.card}>
                    <FormField label="Address Line 1" control={control} name="address_1"
                        inputProps={{ placeholder: 'Address 1', keyboardType: 'default' }} />
                    <FormField label="Address Line 2" control={control} name="address_2"
                        inputProps={{ placeholder: 'Address 2', keyboardType: 'default' }} />
                    <FormField label="Address Line 3" control={control} name="address_3"
